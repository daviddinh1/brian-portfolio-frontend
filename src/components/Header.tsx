      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8 lg:space-x-12">
            <Link
              href="/photography"
              className="text-m font-medium text-gray-900 hover:text-gray-600 transition-colors cursor-pointer"
            >
              PHOTOGRAPHY
            </Link>
            <Link
        ...
        <div className="md:hidden border-t border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white">
            <Link
              href="/videography"
              className="block px-3 py-2 text-base font-medium text-gray-900 hover:text-gray-600 hover:bg-gray-50 cursor-pointer"
            >
              VIDEOGRAPHY
            </Link>
            <Link
